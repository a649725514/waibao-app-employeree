...
export default class Addtask extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            showAnim1: new Animated.Value(0),
            selected: '安全等级',
            selected1: '所属项目',
            //editable:false,
    ...
    showorhideItems1() {
        Animated.timing(
            this.state.showAnim1,
            {
                toValue: this.showorhide1 == 0 ? 1 : 0
            }
        ).start();
        this.showorhide1 = this.showorhide1 == 0 ? 1 : 0;
    }
    render() {
        return (
            <View style={{
                ...
                <View style={{
                    ...
                    <ScrollView>
                        <View style={{
                            ...
                            <Text style={{ color: 'black', marginRight: 50, fontSize: 15 }}>{'名称'}</Text>
                            <TextInput
                                style={{
                                    width: 0.6 * width,
                                    height: 35,
                        ...
                        <View style={{
                            ...
                            <Text style={{ color: 'black', marginRight: 20, fontSize: 15 }}>{'所属项目'}</Text>
                            <View style={{
                                width: width,
                            }}>
                                <TouchableOpacity style={{
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={{ marginLeft: 5 }}>{this.state.selected1}</Text>
                                        </View>
                                        <View style={{
                                            width: 35,
                                            height: 35,
                                ...
                                <Animated.View style={{
                                    width: 0.3 * width,
                                    //position:'absolute',
                                    height: this.state.showAnim1.interpolate({
                                        inputRange: [0, 1],
                                    ...
                                    <ListView
                                        ...
                                        renderRow={(rowData) => this.renderRow3(rowData)}
